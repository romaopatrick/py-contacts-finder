...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            False, ["Patrick", "Patricio"], "re", [], id="should fail for non matches"
        ),
        pytest.param(False, [], "re", [], id="should fail for empty tree"),
        pytest.param(
            True,
            ["Patrick", "Patricio"],
            "pa",
...
def test_search_prefix(
    success: bool, contacts_list: list[str], prefix: str, outputs: list[str]
):
